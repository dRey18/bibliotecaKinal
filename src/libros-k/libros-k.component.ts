...
@Component({
  selector: 'app-libros-k',
  templateUrl: './libros-k.component.html',
  styleUrls: ['./libros-k.component.scss']
})
export class LibrosKComponent implements OnInit {
